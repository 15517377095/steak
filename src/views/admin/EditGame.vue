<template>
    <div class="add-game">
        ...
        <div class="container-fluid">
            <div class="row mt-4">
                <div class="col-auto offset-xl-1 title anim-2">修改游戏</div>
                <div class="col-auto ml-auto">
                    <span class="nav-root">Steak</span>
                    <i class="nav-ico fas fa-angle-right"></i>
                    <span class="nav-child">修改游戏</span>
                </div>
                ...
                <div class="col-xl-10 offset-xl-1 add-form anim-2">
                    <mu-form :model="gameForm" class="row mu-demo-form" label-width="100">
                        ...
                        <mu-form-item class="col-auto ml-auto">
                            <mu-button color="#08f" @click="save">确认修改</mu-button>
                        </mu-form-item>
                    </mu-form>
                </div>
            </div>
        ...
        getGame(){
            this.$http({
                ...
                this.gameForm = {
                    ...
                    imgs: response.data.imgs.split(";"),
                    mdfile: response.data.mdfile
                }
                for(var i = 0; i < this.gameForm.imgs.length; i++){
                    this.uploadimgitems[i] = {
                        imgurl: this.gameForm.imgs[i]
                    }
                }
                this.showMd();
            })
