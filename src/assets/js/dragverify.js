(function($){
    $.fn.dragverify = function(params){
        ...
        var htmls = '<div class="dragverifybg"></div><div class="dragverifytext" onselectstart="return false;" unselectable="on">拖动滑块进行人机验证</div><div class="block blockbg"></div>';
